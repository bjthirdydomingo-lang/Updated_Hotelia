...
INSERT INTO `bookings` (`booking_id`, `reference_no`, `guest_id`, `check_in_date`, `check_out_date`, `nights`, `room_subtotal`, `extra_person_total`, `early_checkin_fee`, `discount_amount`, `grand_total`, `status`, `created_at`, `tax_amount`, `updated_at`) VALUES
	(1, 'HTL260316-4454', 33, '2026-03-16 08:10:24', '2026-03-17 00:00:00', 1, 2500.00, 0.00, 500.00, 0.00, 3700.00, 'checked_out', '2026-03-16 00:10:06', 300.00, '2026-03-16 00:11:06'),
	(2, 'HTL260316-8078', 34, '2026-03-16 10:13:18', '2026-03-17 00:00:00', 1, 3200.00, 0.00, 500.00, 0.00, 4084.00, 'checked_out', '2026-03-16 02:12:59', 384.00, '2026-03-16 02:15:45'),
	(3, 'HTL260316-3799', 8, '2026-03-16 00:00:00', '2026-03-17 00:00:00', 1, 800.00, 0.00, 0.00, 0.00, 896.00, 'confirmed', '2026-03-16 02:29:21', 96.00, '2026-03-16 02:30:10'),
	(4, 'HTL260316-9814', 8, '2026-03-16 10:31:54', '2026-03-17 00:00:00', 1, 4000.00, 0.00, 500.00, 0.00, 4980.00, 'checked_in', '2026-03-16 02:31:17', 480.00, '2026-03-16 02:31:54');

-- Dumping structure for table hotelia_db.booking_amenities
CREATE TABLE IF NOT EXISTS `booking_amenities` (
  ...
  CONSTRAINT `booking_amenities_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table hotelia_db.booking_amenities: ~13 rows (approximately)
DELETE FROM `booking_amenities`;
INSERT INTO `booking_amenities` (`id`, `booking_id`, `amenity_name`, `quantity`, `unit_price`, `total_price`, `created_at`) VALUES
	(1, 3, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-15 05:50:29'),
	(2, 3, 'Extra Mattress', 1, 300.00, 300.00, '2026-03-15 05:50:29'),
	(3, 4, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-15 06:03:22'),
	(4, 5, 'Bath Soap', 1, 15.00, 15.00, '2026-03-15 06:13:56'),
	(5, 5, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-15 06:13:56'),
	(6, 5, 'Early Check-in Fee', 1, 500.00, 500.00, '2026-03-15 05:34:37'),
	(7, 4, 'Early Check-in Fee', 1, 500.00, 500.00, '2026-03-15 05:34:59'),
	(8, 3, 'Early Check-in Fee', 1, 500.00, 500.00, '2026-03-15 05:40:40'),
	(9, 6, 'Early Check-in Fee', 1, 500.00, 500.00, '2026-03-15 05:45:10'),
	(10, 2, 'Early Check-in Fee', 1, 500.00, 500.00, '2026-03-15 06:21:17'),
	(11, 7, 'Bath Robe', 1, 150.00, 150.00, '2026-03-15 08:32:31'),
	(12, 8, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-15 08:51:49'),
	(13, 11, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-15 12:44:07'),
	(14, 9, 'Extra Mattress', 1, 300.00, 300.00, '2026-03-15 13:44:38'),
	(15, 9, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-15 13:44:38'),
	(16, 1, 'Extra Bedsheet', 1, 100.00, 100.00, '2026-03-16 00:10:06'),
	(17, 1, 'Extra Mattress', 1, 300.00, 300.00, '2026-03-16 00:10:06');
...
-- Dumping data for table hotelia_db.booking_items: ~4 rows (approximately)
...
INSERT INTO `booking_items` (`booking_item_id`, `booking_id`, `room_type_id`, `room_id`, `assigned_at`, `assigned_by_staff`, `adults`, `children`, `room_rate_applied`, `extra_person_rate_applied`, `extra_persons`, `item_total`, `status`, `updated_at`) VALUES
	(1, 1, 5, 12, '2026-03-16 00:10:06', 2, 1, 0, 2500.00, 0.00, 0, 2500.00, 'checked_in', '2026-03-16 00:10:24'),
	(2, 2, 6, 15, '2026-03-16 02:12:59', 2, 1, 0, 3200.00, 0.00, 0, 3200.00, 'checked_in', '2026-03-16 02:13:18'),
	(3, 3, 14, NULL, NULL, NULL, 1, 0, 800.00, 0.00, 0, 800.00, 'confirmed', '2026-03-16 02:30:10'),
	(4, 4, 9, 21, '2026-03-16 02:31:47', 2, 1, 0, 4000.00, 0.00, 0, 4000.00, 'checked_in', '2026-03-16 02:31:54');
...
-- Dumping data for table hotelia_db.guests: ~26 rows (approximately)
DELETE FROM `guests`;
...
INSERT INTO `guests` (`guest_id`, `account_id`, `full_name`, `phone`, `email`, `guest_type`, `created_at`) VALUES
	...
	(23, NULL, 'as saaddasd asddas', '09156526156', 'a@dog.com', 'room_guest', '2026-03-15 05:09:24'),
	(24, NULL, 'asas asas saas', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 05:40:20'),
	(25, NULL, 'sada dasd das', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 05:50:29'),
	(26, NULL, 'sadas dad das', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 06:03:22'),
	(27, NULL, 'xax czd czd', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 06:13:56'),
	(28, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 08:32:31'),
	(29, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 08:51:49'),
	(30, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 10:24:48'),
	(31, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 12:08:13'),
	(32, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-15 12:44:07'),
	(33, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-16 00:10:06'),
	(34, NULL, 'a a a', '09156526156', 'aj@email.com', 'room_guest', '2026-03-16 02:12:59');
...
-- Dumping data for table hotelia_db.guest_details: ~16 rows (approximately)
...
INSERT INTO `guest_details` (`detail_id`, `guest_id`, `id_type`, `id_number`, `address`, `emergency_contact`, `emergency_contact_number`, `profile_picture`, `id_document_photo`) VALUES
	...
	(20, 23, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 41, Balacad, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(21, 24, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 37, Calayab, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(22, 25, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 56-A, Bacsil North, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(23, 26, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 25, Santa Cayetana (Poblacion), Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL);
INSERT INTO `guest_details` (`detail_id`, `guest_id`, `id_type`, `id_number`, `address`, `emergency_contact`, `emergency_contact_number`, `profile_picture`, `id_document_photo`) VALUES
	(24, 27, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 25, Santa Cayetana (Poblacion), Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(25, 28, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 43, Cavit, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(26, 29, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 37, Calayab, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(27, 30, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 43, Cavit, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(28, 31, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 25, Santa Cayetana (Poblacion), Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(29, 32, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 25, Santa Cayetana (Poblacion), Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(30, 33, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 37, Calayab, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL),
	(31, 34, 'Driver\'s License', 'A01-22-123456', 'Barangay No. 40, Balatong, Laoag City, Ilocos Norte', NULL, NULL, NULL, NULL);
...
INSERT INTO `inventory_items` (`item_id`, `item_name`, `category`, `stock_level`, `unit_of_measure`, `min_stock_threshold`) VALUES
	(1, 'Pork Belly', 'Meat', 49.20, 'kg', 10.00),
	(2, 'Beef Shank', 'Meat', 30.00, 'kg', 5.00),
	(3, 'Whole Chicken', 'Meat', 40.00, 'pcs', 10.00),
	(4, 'Ground Pork', 'Meat', 0.00, 'kg', 5.00),
	(5, 'Squid (Large)', 'Seafood', 11.20, 'kg', 5.00),
	(6, 'Calamansi', 'Produce', 450.00, 'pcs', 100.00),
	(7, 'Rice (Jasmine)', 'Dry Goods', 100.00, 'kg', 20.00),
	(8, 'Soy Sauce', 'Dry Goods', 20.00, 'L', 5.00),
	(9, 'Vinegar', 'Dry Goods', 20.00, 'L', 5.00),
	(10, 'Cooking Oil', 'Dry Goods', 49.70, 'L', 10.00),
	(11, 'Eggplant', 'Produce', 30.00, 'pcs', 10.00),
	(12, 'Coconut Milk', 'Dairy', 40.00, 'L', 10.00),
	(13, 'Sugar (White)', 'Dry Goods', 24.80, 'kg', 5.00),
	(14, 'Coffee Beans (Barako)', 'Dry Goods', 6.00, 'kg', 2.00),
...
INSERT INTO `login_attempts` (`id`, `username`, `ip_address`, `success`, `attempted_at`) VALUES
	...
	(578, 'cashier', '::1', 0, '2026-03-14 09:50:52'),
	(579, 'cashier', '::1', 1, '2026-03-14 09:50:55'),
	(580, 'waiter', '::1', 1, '2026-03-14 10:03:57'),
	(581, 'cashier', '::1', 1, '2026-03-15 01:54:27'),
	(582, 'kitchen', '::1', 1, '2026-03-15 02:17:59'),
	(583, 'cashier', '::1', 1, '2026-03-15 02:20:47');
INSERT INTO `login_attempts` (`id`, `username`, `ip_address`, `success`, `attempted_at`) VALUES
	(584, 'waiter', '::1', 1, '2026-03-15 02:21:02'),
	(585, 'admin', '::1', 1, '2026-03-15 02:58:54'),
	(586, 'waiter', '::1', 1, '2026-03-15 03:05:15'),
	(587, 'cashier', '::1', 1, '2026-03-15 03:05:40'),
	(588, 'waiter', '::1', 0, '2026-03-15 03:39:27'),
	(589, 'cashier', '::1', 1, '2026-03-15 03:39:38'),
	(590, 'cashier', '::1', 1, '2026-03-15 03:52:22'),
	(591, 'cashier', '::1', 1, '2026-03-15 03:54:18'),
	(592, 'reception_staff', '::1', 1, '2026-03-15 03:55:19'),
	(593, 'bj', '::1', 1, '2026-03-15 05:42:20'),
	(594, 'reception_staff', '::1', 1, '2026-03-15 05:43:31'),
	(595, 'cashier', '::1', 1, '2026-03-15 12:48:03'),
	(596, 'admin', '::1', 1, '2026-03-15 13:58:36'),
	(597, 'admin', '::1', 1, '2026-03-15 14:00:56'),
	(598, 'reception_staff', '::1', 1, '2026-03-15 14:01:08'),
	(599, 'cashier', '::1', 1, '2026-03-15 14:02:52'),
	(600, 'bj', '::1', 1, '2026-03-15 14:09:47'),
	(601, 'kitchen', '::1', 1, '2026-03-15 14:11:24'),
	(602, 'reception_staff', '::1', 1, '2026-03-16 00:08:29'),
	(603, 'reception_staff', '::1', 1, '2026-03-16 02:08:05'),
	(604, 'waiter', '::1', 1, '2026-03-16 02:17:52'),
	(605, 'kitchen', '::1', 1, '2026-03-16 02:18:43'),
	(606, 'cashier', '::1', 1, '2026-03-16 02:20:43'),
	(607, 'kitchen', '::1', 1, '2026-03-16 02:22:31'),
	(608, 'cashier', '::1', 1, '2026-03-16 02:22:54'),
	(609, 'bj', '::1', 1, '2026-03-16 02:26:34'),
	(610, 'reception_staff', '::1', 1, '2026-03-16 02:30:03'),
	(611, 'cashier', '::1', 1, '2026-03-16 02:35:57'),
	(612, 'waiter', '::1', 1, '2026-03-16 02:37:03'),
	(613, 'kitchen', '::1', 1, '2026-03-16 02:37:33');
...
INSERT INTO `menu_items` (`item_id`, `category_id`, `item_name`, `item_description`, `price`, `image_path`, `status`, `is_special`, `is_available`, `inventory_item_id`, `stock_quantity`, `available_servings`) VALUES
	(1, 1, 'Lumpiang Shanghai', NULL, 185.00, 'lumpia_shanghai.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(2, 1, 'Pork Sisig (Sizzling)', NULL, 220.00, 'pork_sisig.jpg', 'available', 0, 1, NULL, 0, 24),
	(3, 1, 'Chicharon Bulaklak', NULL, 195.00, 'chicharon-bulaklak.jpg', 'available', 0, 1, NULL, 0, 5),
	(4, 1, 'Tokwa’t Baboy', NULL, 165.00, 'tokwa_baboy.webp', 'unavailable', 0, 0, NULL, 0, 0),
	(5, 1, 'Calamares', NULL, 240.00, 'calamares.jpg', 'available', 0, 1, NULL, 0, 37),
	(6, 2, 'Sinigang na Baboy', NULL, 350.00, 'sinigang_baboy.webp', 'available', 0, 1, NULL, 0, 123),
	(7, 2, 'Bulalo (Beef Shank Soup)', NULL, 480.00, 'bulalo.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(8, 2, 'Chicken Binakol', NULL, 320.00, 'chicken_binakol.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(9, 2, 'Pancit Molo', NULL, 180.00, 'pancit_molo.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(10, 2, 'Tinola na Manok', NULL, 290.00, 'chicken_tinola.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(11, 3, 'Ensaladang Talong (Eggplant)', NULL, 120.00, 'ensalada_talong.jpg', 'available', 0, 1, NULL, 0, 10),
	(12, 3, 'Atcharang Papaya', NULL, 85.00, 'atchara.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(13, 3, 'Ensaladang Mangga at Bagoong', NULL, 110.00, 'ensalada_mangga.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(14, 3, 'Pako (Fiddlehead Fern) Salad', NULL, 155.00, 'pako_salad.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(15, 3, 'Ensaladang Kamatis at Sibuyas', NULL, 95.00, 'tomato_salad.webp', 'unavailable', 0, 0, NULL, 0, 0),
	(16, 4, 'Beef Caldereta', NULL, 380.00, 'beef_caldereta.jpeg', 'available', 0, 1, NULL, 0, 30);
INSERT INTO `menu_items` (`item_id`, `category_id`, `item_name`, `item_description`, `price`, `image_path`, `status`, `is_special`, `is_available`, `inventory_item_id`, `stock_quantity`, `available_servings`) VALUES
	(17, 4, 'Chicken/Pork Adobo', NULL, 310.00, 'adobo.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(18, 4, 'Kare-Kare (Oxtail/Beef)', NULL, 450.00, 'kare_kare.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(19, 4, 'Crispy Pata (Deep Fried Trotter)', NULL, 650.00, 'crispy_pata.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(20, 4, 'Lechon Kawali', NULL, 340.00, 'lechon_kawali.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(21, 5, 'Halo-Halo Especial', NULL, 145.00, 'halo_halo.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(22, 5, 'Leche Flan', NULL, 120.00, 'leche_flan.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(23, 5, 'Buko Pandan', NULL, 85.00, 'buko_pandan.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(24, 5, 'Turon with Ice Cream', NULL, 110.00, 'turon.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(25, 5, 'Bibingka (Rice Cake)', NULL, 130.00, 'bibingka.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(26, 6, 'Sago’t Gulaman', NULL, 65.00, 'sago_gulaman.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(27, 6, 'Fresh Buko Juice', NULL, 95.00, 'buko_juice.jpg', 'unavailable', 0, 0, NULL, 0, 0),
	(28, 6, 'Calamansi Juice (Hot/Cold)', NULL, 55.00, 'calamansi.webp', 'available', 0, 1, NULL, 0, 90),
	(29, 6, 'San Miguel Beer (Pilsen)', NULL, 80.00, 'sm_pilsen.webp', 'unavailable', 0, 0, NULL, 0, 0),
	(30, 6, 'Brewed Barako Coffee', NULL, 75.00, 'barako_coffee.webp', 'available', 0, 1, NULL, 0, 6),
	(31, 4, 'Rice', NULL, 75.00, 'rice.jpg', 'available', 0, 1, NULL, 0, 666);
...
-- Dumping data for table hotelia_db.menu_item_ingredients: ~12 rows (approximately)
...
-- Dumping data for table hotelia_db.orders: ~3 rows (approximately)
DELETE FROM `orders`;
INSERT INTO `orders` (`order_id`, `booking_id`, `waiter_id`, `cashier_id`, `table_number`, `room_number`, `total_amount`, `status`, `billing_method`, `billing_status`, `order_source`, `is_billed`, `created_at`, `updated_at`, `amount_received`, `amount_change`) VALUES
	(1, NULL, NULL, NULL, '1', NULL, 414.40, 'delivered', 'instant', 'paid', 'waiter', 1, '2026-03-16 02:18:04', '2026-03-16 02:24:45', 500.00, 85.60),
	(2, NULL, NULL, NULL, '2', NULL, 660.80, 'ready', 'instant', 'paid', 'cashier', 1, '2026-03-16 02:36:42', '2026-03-16 02:37:38', 700.00, 39.20),
	(3, NULL, NULL, NULL, '1', NULL, 655.20, 'pending', 'instant', 'paid', 'waiter', 1, '2026-03-16 02:37:13', '2026-03-16 02:38:27', 700.00, 44.80);
...
-- Dumping data for table hotelia_db.order_items: ~4 rows (approximately)
DELETE FROM `order_items`;
INSERT INTO `order_items` (`order_item_id`, `order_id`, `menu_item_id`, `quantity`, `price_at_order`, `notes`, `item_status`) VALUES
	(1, 1, 1, 2, 185.00, '', 'picked_up'),
	(2, 2, 6, 1, 350.00, '', 'served'),
	(3, 2, 5, 1, 240.00, '', 'served'),
	(4, 3, 3, 3, 195.00, '', 'pending');
...
INSERT INTO `payments` (`payment_id`, `booking_id`, `guest_id`, `payment_method_id`, `paid_amount`, `payment_reference`, `user_reference`, `verification_attempts`, `status`, `payment_date`, `processed_by_staff`, `receipt_number`, `verification_notes`, `verified_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 33, 6, 1600.00, 'Cash (walk-in)', 'Cash (walk-in)', 0, 'completed', '2026-03-16 00:10:06', 2, NULL, NULL, '2026-03-16 08:10:06', '2026-03-16 00:10:06', '2026-03-16 00:10:06'),
	(2, 2, 34, 6, 1792.00, 'Cash (walk-in)', 'Cash (walk-in)', 0, 'completed', '2026-03-16 02:12:59', 2, NULL, NULL, '2026-03-16 10:12:59', '2026-03-16 02:12:59', '2026-03-16 02:12:59'),
	(3, 3, 8, 3, 448.00, 'GC-260316-8E822', 'GC-260316-8E822', 0, 'completed', '2026-03-16 02:29:21', 2, 'PMY-160326-D12E6', '', '2026-03-16 10:30:10', '2026-03-16 02:29:21', '2026-03-16 02:30:10'),
	(4, 4, 8, 3, 2240.00, 'GC-260316-4FBBB', 'GC-260316-4FBBB', 0, 'completed', '2026-03-16 02:31:17', 2, 'PMY-160326-A1245', '', '2026-03-16 10:31:40', '2026-03-16 02:31:17', '2026-03-16 02:31:40');
...
-- Dumping data for table hotelia_db.payment_method_details: ~2 rows (approximately)
...
INSERT INTO `payment_method_details` (`detail_id`, `payment_id`, `method_type`, `account_reference`, `authorization_code`, `gateway_response`, `created_at`) VALUES
	(1, 3, 'gcash', '09999999999', NULL, '{}', '2026-03-16 02:29:21'),
	(2, 4, 'gcash', '09851132113', NULL, '{}', '2026-03-16 02:31:18');
...
-- Dumping data for table hotelia_db.pos_transactions: ~4 rows (approximately)
...
INSERT INTO `pos_transactions` (`transaction_id`, `booking_id`, `reference_no`, `transaction_amount`, `payment_method_id`, `staff_id`, `processed_at`, `status`, `transaction_type`, `auth_code`, `receipt_number`, `payment_reference`) VALUES
	(1, 1, 'POS-20260316-R2BZ', 1600.00, 6, 2, '2026-03-16 00:10:06', 'completed', 'booking_full', NULL, NULL, 'Cash (walk-in)'),
	(2, 1, 'POS260316001106-4503', 2100.00, 6, NULL, '2026-03-16 00:11:06', 'completed', 'checkout_balance', NULL, NULL, NULL),
	(3, 2, 'POS-20260316-ESCF', 1792.00, 6, 2, '2026-03-16 02:12:59', 'completed', 'booking_full', NULL, NULL, 'Cash (walk-in)'),
	(4, 2, 'POS260316021545-0046', 2292.00, 6, NULL, '2026-03-16 02:15:45', 'completed', 'checkout_balance', NULL, NULL, NULL);

-- Dumping structure for procedure hotelia_db.recalculate_all_servings
DELIMITER //
CREATE PROCEDURE `recalculate_all_servings`()
BEGIN
    UPDATE menu_items mi
    SET mi.available_servings = COALESCE(
        (
            SELECT FLOOR(MIN(ii.stock_level / mii.quantity_needed))
...
INSERT INTO `rooms` (`room_id`, `room_number`, `floor`, `room_type_id`, `bed_type_id`, `view_type_id`, `capacity`, `max_extra`, `status`, `description`, `created_at`, `maintenance_status`, `updated_at`) VALUES
	...
	(9, 'G103', 1, 4, 8, 6, 2, 1, 'reserved', 'Comfortable standard room with pool view', '2025-10-06 05:32:56', 'good', '2026-03-15 05:44:55'),
...
INSERT INTO `rooms` (`room_id`, `room_number`, `floor`, `room_type_id`, `bed_type_id`, `view_type_id`, `capacity`, `max_extra`, `status`, `description`, `created_at`, `maintenance_status`, `updated_at`) VALUES
	...
	(21, '303', 3, 9, 8, 5, 2, 1, 'reserved', 'Modern junior suite with sea view', '2025-10-06 05:32:56', 'good', '2026-03-16 02:31:47'),
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Stores guest room selections before booking confirmation';

-- Dumping data for table hotelia_db.room_selections: ~1 rows (approximately)
...
INSERT INTO `service_requests` (`request_id`, `guest_id`, `booking_id`, `category_id`, `form_id`, `room_id`, `title`, `description`, `request_data`, `priority`, `status`, `guest_room_number`, `created_at`, `updated_at`) VALUES
	(1, 8, 4, 1, 1, 21, 'Room Amenities Request', '', '{"request_type": "towel_change", "special_instructions": ""}', 'medium', 'pending', '303', '2026-03-16 02:32:13', '2026-03-16 02:32:13');
...
-- Dumping data for table hotelia_db.user_sessions: ~41 rows (approximately)
...
-- Dumping structure for trigger hotelia_db.update_menu_servings_on_inventory_change
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `update_menu_servings_on_inventory_change` AFTER UPDATE ON `inventory_items` FOR EACH ROW BEGIN
...
-- Dumping structure for trigger hotelia_db.update_menu_status_before_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `update_menu_status_before_update` BEFORE UPDATE ON `menu_items` FOR EACH ROW BEGIN
    IF NEW.available_servings > 0 THEN
