...
INSERT INTO `bookings` (`booking_id`, `reference_no`, `guest_id`, `check_in_date`, `check_out_date`, `nights`, `base_amount`, `total_amount`, `status`, `created_at`, `tax_amount`, `extra_person_charges`) VALUES
	(1, 'HTL251108-1383', 1, '2025-12-08', '2025-12-09', 1, 5500.00, 6160.00, 'confirmed', '2025-12-08 07:14:25', 660.00, 0.00),
	(2, 'HTL251108-3178', 1, '2025-12-06', '2025-12-10', 2, 3000.00, 3360.00, 'checked_in', '2025-12-06 07:21:39', 360.00, 0.00),
	(3, 'HTL251108-3559', 1, '2025-12-08', '2025-12-10', 2, 3200.00, 3584.00, 'confirmed', '2025-12-08 07:24:58', 384.00, 0.00),
	(4, 'HTL251118-2404', 1, '2025-12-07', '2025-12-20', 1, 3000.00, 4032.00, 'cancelled', '2025-12-07 13:16:18', 432.00, 600.00);
...
INSERT INTO `booking_items` (`booking_item_id`, `booking_id`, `room_type_id`, `room_id`, `adults`, `children`, `item_price`, `status`, `base_price`, `extra_person_charges`, `check_in_date`, `check_out_date`) VALUES
	(1, 1, 10, 23, 1, 0, 5500.00, 'confirmed', 5500.00, 0.00, NULL, NULL),
	(2, 2, 4, 23, 1, 0, 3000.00, 'confirmed', 3000.00, 0.00, NULL, NULL),
	(3, 3, 14, NULL, 1, 1, 1600.00, 'confirmed', 1600.00, 0.00, NULL, NULL),
	(4, 3, 14, NULL, 1, 0, 1600.00, 'confirmed', 1600.00, 0.00, NULL, NULL),
	(5, 4, 4, NULL, 3, 0, 1800.00, 'confirmed', 1500.00, 300.00, NULL, NULL),
	(6, 4, 4, NULL, 1, 2, 1800.00, 'confirmed', 1500.00, 300.00, NULL, NULL);
...
-- Dumping data for table hotelia_db.login_attempts: ~146 rows (approximately)
...
INSERT INTO `rooms` (`room_id`, `room_number`, `floor`, `room_type_id`, `bed_type_id`, `view_type_id`, `capacity`, `max_extra`, `extra_person_rate`, `base_price`, `status`, `description`, `created_at`, `maintenance_status`) VALUES
	...
	(23, '305', 3, 10, 9, 5, 2, 1, 700.00, 5500.00, 'occupied', 'Premium executive suite with sea view and work area', '2025-10-06 05:32:56', 'good'),
...
-- Dumping structure for table hotelia_db.room_reservations
CREATE TABLE IF NOT EXISTS `room_reservations` (
  ...
  CONSTRAINT `room_reservations_ibfk_2` FOREIGN KEY (`booking_item_id`) REFERENCES `booking_items` (`booking_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table hotelia_db.room_reservations: ~0 rows (approximately)
...
-- Dumping data for table hotelia_db.service_requests: ~6 rows (approximately)
INSERT INTO `service_requests` (`request_id`, `guest_id`, `booking_id`, `category_id`, `form_id`, `room_id`, `title`, `description`, `request_data`, `priority`, `status`, `guest_room_number`, `created_at`, `updated_at`) VALUES
	...
	(10, 1, NULL, 1, 1, 23, 'Room Amenities Request', 'fafa', '{"request_type": "towel_change", "special_instructions": "fafa"}', 'medium', 'pending', '305', '2025-12-03 13:44:05', '2025-12-03 13:44:05');
...
INSERT INTO `user_sessions` (`session_id`, `account_id`, `session_token`, `ip_address`, `user_agent`, `created_at`, `expires_at`) VALUES
	(135, 1, '270et6omsgo59r498tee617g7v', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '2025-12-06 12:27:55', '2025-12-06 13:32:56'),
	(136, 4, 'griajgr4ir8dtq9pgmsof25f6s', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36 Edg/142.0.0.0', '2025-12-06 12:36:12', '2025-12-06 14:02:37');
...
-- Dumping structure for trigger hotelia_db.prevent_double_booking
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `prevent_double_booking` BEFORE INSERT ON `room_reservations` FOR EACH ROW BEGIN
    IF EXISTS (
