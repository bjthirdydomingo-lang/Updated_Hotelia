...
-- Dumping data for table hotelia_db.accounts: ~21 rows (approximately)
...
-- Dumping data for table hotelia_db.bookings: ~0 rows (approximately)
...
-- Dumping data for table hotelia_db.booking_items: ~0 rows (approximately)
...
INSERT INTO `inventory_items` (`item_id`, `item_name`, `category`, `stock_level`, `unit_of_measure`, `min_stock_threshold`) VALUES
	...
	(10, 'Cooking Oil', 'Dry Goods', 49.75, 'L', 10.00),
...
-- Dumping data for table hotelia_db.login_attempts: ~577 rows (approximately)
...
INSERT INTO `menu_items` (`item_id`, `category_id`, `item_name`, `item_description`, `price`, `image_path`, `status`, `is_special`, `is_available`, `inventory_item_id`, `stock_quantity`, `available_servings`) VALUES
	(1, 1, 'Lumpiang Shanghai', NULL, 185.00, 'lumpia_shanghai.jpg', 'available', 0, 1, NULL, 0, 2),
	(2, 1, 'Pork Sisig (Sizzling)', NULL, 220.00, 'pork_sisig.jpg', 'available', 0, 1, NULL, 0, 25),
	(3, 1, 'Chicharon Bulaklak', NULL, 195.00, 'chicharon-bulaklak.jpg', 'available', 0, 1, NULL, 0, 6),
	(4, 1, 'Tokwa’t Baboy', NULL, 165.00, 'tokwa_baboy.webp', 'unavailable', 0, 0, NULL, 0, 0),
	(5, 1, 'Calamares', NULL, 240.00, 'calamares.jpg', 'available', 0, 1, NULL, 0, 45),
	(6, 2, 'Sinigang na Baboy', NULL, 350.00, 'sinigang_baboy.webp', 'available', 0, 1, NULL, 0, 125),
	...
	(16, 4, 'Beef Caldereta', NULL, 380.00, 'beef_caldereta.jpeg', 'available', 0, 1, NULL, 0, 29);
INSERT INTO `menu_items` (`item_id`, `category_id`, `item_name`, `item_description`, `price`, `image_path`, `status`, `is_special`, `is_available`, `inventory_item_id`, `stock_quantity`, `available_servings`) VALUES
...
-- Dumping data for table hotelia_db.menu_item_ingredients: ~13 rows (approximately)
...
INSERT INTO `orders` (`order_id`, `booking_id`, `waiter_id`, `cashier_id`, `table_number`, `room_number`, `total_amount`, `status`, `billing_method`, `billing_status`, `order_source`, `is_billed`, `created_at`, `updated_at`, `amount_received`, `amount_change`) VALUES
	(1, NULL, 5, 5, '1', NULL, 3707.20, 'ready', 'instant', 'unpaid', 'waiter', 0, '2026-03-14 07:22:48', '2026-03-14 07:50:42', 0.00, 0.00);
...
-- Dumping data for table hotelia_db.order_items: ~6 rows (approximately)
DELETE FROM `order_items`;
INSERT INTO `order_items` (`order_item_id`, `order_id`, `menu_item_id`, `quantity`, `price_at_order`, `notes`, `item_status`) VALUES
	(1, 1, 16, 1, 380.00, '', 'served'),
	(2, 1, 5, 5, 240.00, '', 'served'),
	(3, 1, 28, 6, 55.00, '', 'served'),
	(4, 1, 28, 10, 55.00, '', 'served'),
	(5, 1, 28, 10, 55.00, '', 'served'),
	(6, 1, 30, 4, 75.00, '', 'served');
...
-- Dumping data for table hotelia_db.payments: ~0 rows (approximately)
...
-- Dumping data for table hotelia_db.rooms: ~23 rows (approximately)
DELETE FROM `rooms`;
...
-- Dumping data for table hotelia_db.room_type_amenities: ~145 rows (approximately)
...
-- Dumping data for table hotelia_db.room_type_images: ~111 rows (approximately)
...
-- Dumping data for table hotelia_db.service_categories: ~7 rows (approximately)
...
-- Dumping data for table hotelia_db.user_sessions: ~43 rows (approximately)
